...
urlpatterns = [
    ...
    path(
        'books/modify/<int:book_id>',
        bsav.modify_book.as_view(),
        name='modify_book'
    ),
    ...
    path(
        'genres/modify/<int:genre_id>',
        bsav.modify_genre.as_view(),
        name='modify_genre'
    ),
    path(
        'genres/delete/<int:genre_id>',
        bsav.delete_genre,
        name='delete_genre'
    ),
    path(
        'books/modify_book_genres/<int:book_id>',
        bsav.modify_book_genres.as_view(),
        name='modify_book_genres'
    )
]
